            ...
            <div class="d-none justify-content-center d-xxl-block   position-fixed" style="max-width: 300px; width: 100%; z-index: 4;overflow: hidden; ">
              ...
              <div class="dropdown-itemrounded text-center    d-flex flex-column " style="margin-top: 90px;">
                <a href="#" class=" d-block align-items-center text-decoration-none text-dark" >
                  <div class="p-2">
                    <img src="../img/profile pics/profile.jpg" alt="avatar"class="rounded-circle me-2"style="width: 80px; height: 80px; object-fit: cover"/>
                  </div>
                  <div>
                    <!-- <p class="m-0">Mac Miller</p> -->
                ...
                <div class="mt-3">
                  ...
                  <div>
                    ...
                    <div class="text-center">
                      <img src="../img/Vegetables/cabbage-3.jpg" id="myImg" alt="post image"class="img-fluid rounded " style="object-fit: none; object-position: center;   width: 100%;max-height: 400px;" />
                    </div>
               ...
               <div class="bg-white p-4 rounded shadow mt-3">
                ...
                <div class="mt-3">
                  ...
                  <div >
                    ...
                    <div class="text-center img-post d-flex gap-2 y-2"> 
                      <img src="../img/Vegetables/cabbage-3.jpg" id="myImg" alt="post image"class="img-fluid rounded " style="object-fit: none; object-position: center;   width: 50%;max-height: 230px;" />
                      <img src="../img/Vegetables/onions-3.jpg" id="myImg" alt="post image"class="img-fluid rounded " style="object-fit: none; object-position: center;   width: 50%;max-height: 230px;" />
                      </div>
                      <div class="text-center img-post d-flex gap-2 y-2 mt-2"> 
                      <img src="../img/Vegetables/cabbage-3.jpg" id="myImg" alt="post image"class="img-fluid rounded " style="object-fit: none; object-position: center;   width: 50%;max-height: 230px;" />
                      <img src="../img/Vegetables/onions-3.jpg" id="myImg" alt="post image"class="img-fluid rounded " style="object-fit: none; object-position: center;   width: 50%;max-height: 230px;" />
                    </div>
