<!DOCTYPE html>
  ...
  <body>
    ...
    .w-100 {
      height: 100vh;
        ...
        .header{
        background-image: linear-gradient(rgba(1,2,2,0.7),rgba(0,1,1,0.4)), url(../img/fruits/fruit-pineapple.jpeg);
 ...
 <div class="site-section">
    <div class="container">
      ...
      margin-bottom: 10%; font-size: 70px; margin-left: 2%;margin-top: 10%;">All About Pineapples</h1>
      <div class="row justify-content-between align-items-center">
        <div class="col-lg-5 order-lg-1 ">
          <div class="pineapple-info">
            <img src="../img/fruits/fruit-pineapple.jpeg" style="width: 100%; margin-top: 5%; height: 60%;">
        </div>
        </div>
        
        <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0">
          <h2 class="text-title mb-2" style="color: #fff; font-family: Georgia, 'Times New Roman', Times, serif;
          font-size: 42px; letter-spacing: 1px; margin-bottom: 15%;">How do pineapples grow?</h2>
          <p class="mb-3" style="text-align: justify; color: #fff;  letter-spacing: 2px; margin-top: 5%;
          font-size: 17px;">Pineapple thrives best in sandy loam to clay loam soil which is well-drained,
            rich in organic matter and has a pH of 4.5 to 5.5. It requires mild (240C to 300C) and
            relatively uniform temperature throughout the year. Pineapples aren't hard to grow but they do take a time commitment; depending on the method, it may be several years until the plant flowers and produces fruit. 
            If you want to grow your own pineapples, there are three ways to get started.
          </p>
          <h2 class="text-title mb-2" style="color: #fff; font-family: Georgia, 'Times New Roman', Times, serif;
          font-size: 42px; letter-spacing: 1px; margin-bottom: 15%;">What season do pineapples grow in?</h2>
          <p class="mb-3" style="text-align: justify; color: #fff;  letter-spacing: 2px; margin-top: 5%;
          font-size: 17px;">It requires evenly distributed
            rainfall (100-150 cm/year) and a very short dry season. Pineapple grows best at an
            elevations of 1,000 feet or 150 to 200 meters above sea level.</p>
          <h2 class="text-title mb-2" style="color: #fff; font-family: Georgia, 'Times New Roman', Times, serif;
          font-size: 42px; letter-spacing: 1px; margin-bottom: 15%;">Nutrition Facts</h2>
           <p class="mb-3" style="text-align: justify; color: #fff;  letter-spacing: 2px; margin-top: 5%;
           font-size: 17px;"> 82 calories,
          0.2 grams (g) of fat, 0 g of cholesterol, 2 milligrams (mg) of sodium, 21.65 g of total carbohydrate (including 16 grams of sugar and 2.3 grams of fiber),
          0.89 g of protein, 131 percent of vitamin C,
          2 percent of vitamin A, 2 percent of calcium, 3 percent of iron. Pineapple is also a source of important vitamins and minerals, including:
          thiamin, riboflavin, vitamin B-6, folate, pantothenic acid, magnesium, manganese, potassium, beta-carotene and other antioxidants.</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="site-section">
          <div class="container">
            <div class="row justify-content-between align-items-center">
              <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0">
                <div class="pineapple-info">
                  <img src="../img/fruits/pineapple-2.jpeg" style="width: 100%;">
              </div>
              </div>

              <div class="col-lg-5 order-lg-1">
                <h2 class="text-title mb-2" style="color: #fff; font-family: Georgia, 'Times New Roman', Times, serif;
                font-size: 45px; letter-spacing: 1px;;">How Long Do Pineapples Last?</h2>
                <p class="mb-3" style="text-align: justify; color: #fff;  letter-spacing: 2px; margin-top: 5%;
                font-size: 19px;"> Lifespan of a pineapple plant is 7 years. First fruit is borne only after the 2nd year. Every year thereafter each plant produces only 1 fruit.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="site-section">
        <div class="container">
          <div class="row justify-content-between align-items-center">
            <div class="col-lg-5 order-lg-1">
              <img src = "/img/fruits/pineapple-3.jpg" style="width: 100%;  margin-top: 5%;">
            </div>
            <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0">
              ...
              <p class="mb-4" style="margin-left: 1%; text-align: justify; color: #fff; font-size: 19px; letter-spacing: 2px;">If the bottom is mushy, wet, or moldy, 
                the pineapple has probably gone bad and is not safe to eat. Take a look at the body as well. 
                If its color is orange, dark gold, or brown instead of green or yellow, the fruit inside has probably started to spoil.
                 </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-12">
          <div class="row">
            ...
            margin-right: 1%; margin-left: 1%;"> Pineapple Growth Timelapse</h1>
            <div class="ratio ratio-16x9">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/KlsCAVbaskY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; 
