  ...
  <body>
    ...
    .w-100 {
      height: 100vh;
        ...
        .header{
        background-image: linear-gradient(rgba(1,2,2,0.4),rgba(0,1,1,0.4)), url('../img/bg/fruit-bg.jpeg');
        ...
        <div class="container">
            ...
            <div class="fruits-gallery">
                <div class="pic cherry">
                    <figure class="effect-ming tm-pic-item">
                        <img src="../img/fruits/fruit-cherry.jpg" alt="Image" class="img-fluid">
                  ...
                  <div class="pic orange">
                    <figure class="effect-ming tm-pic-item">
                        <img src="../img/fruits/fruit-orange.jpg" alt="Image" class="img-fluid">
                        <figcaption class="d-flex align-items-center justify-content-center">
                            <h2>Orange</h2>
                            <a href="../pages_php/fruit-detail.php"></a>
                        </figcaption>                    
                  ...
                  <div class="pic pomelo">
                    <figure class="effect-ming tm-pic-item">
                        <img src="../img/fruits/fruit-pomelo.jpeg" alt="Image" class="img-fluid">
                        <figcaption class="d-flex align-items-center justify-content-center">
                            <h2>Pomelo</h2>
                            <a href="../pages_php/fruit-detail.php"></a>
                        </figcaption>                    
                  ...
                  <div class="pic lychee">
                    <figure class="effect-ming tm-pic-item">
                        <img src="../img/fruits/fruit-lychee.jpeg" alt="Image" class="img-fluid">
                        <figcaption class="d-flex align-items-center justify-content-center">
                            <h2>Lychee</h2>
                            <a href="../pages_php/fruit-detail.php"></a>
                        </figcaption>                    
