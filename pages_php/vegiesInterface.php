...
include "../components/nav_bar.php"?>
    ...
    <div class="header">
        ...
        <div class="container">
            <h1 class="fruit-header">Vegetables</h1>
...
$query = "SELECT ROW_NUMBER() OVER(ORDER BY title ASC) as `row`,`title`,`cover_img`,`category` FROM learning_contents WHERE category = 'vegetables';";
...
?>
        ...
        <nav aria-label="page-navigation">
            ...
            <?php
                ...
                for($i = 1; $i <= $page; $i++){
                    if($i == $curr_page){
                        echo "<li class='page-item active' aria-current='page'><a class='page-link' href = 'vegiesInterface.php?page=$i'>".$i."</a></li>";
                    }else{
                        echo "<li class='page-item' aria-current='page'><a class='page-link' href = 'vegiesInterface.php?page=$i'>".$i."</a></li>";
                    }
                }
            ?>
