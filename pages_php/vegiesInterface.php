...
<div class="container">
  ...
  <div class="vegetables-gallery">
    <div class="pic cabbage">
          <figure class="effect-ming tm-pic-item">
              <img src ="../img/vegetables/cabbage-bg.jpeg" alt="Image" class="img-fluid"> 
        ...
        <div class="pic carrot">
          <figure class="effect-ming tm-pic-item">
              <img src="../img/vegetables/carrot-bg.jpg" alt="Image" class="img-fluid">
              <figcaption class="d-flex align-items-center justify-content-center">
                  <h2>Carrot</h2>
                  <a href="../pages_php/vegies-detail.php"></a>
              </figcaption>                    
        ...
        <div class="pic eggplant">
          <figure class="effect-ming tm-pic-item">
              <img src="../img/vegetables/eggplant-bg.jpeg" alt="Image" class="img-fluid">
              <figcaption class="d-flex align-items-center justify-content-center">
                  <h2>Eggplant</h2>
                  <a href="../pages_php/vegies-detail.php"></a>
                </figcaption>                    
    ...
    <div class="pic pumpkin">
    <figure class="effect-ming tm-pic-item">
        <img src="../img/vegetables/pumpkin-bg.jpeg" alt="Image" class="img-fluid">
        <figcaption class="d-flex align-items-center justify-content-center">
            <h2>Pumpkin</h2>
            <a href="../pages_php/vegies-detail.php"></a>
        </figcaption>                    
...
<nav aria-label="page-navigation">
    ...
    <li class="page-item"><a class="page-link" href="../pages_php/vegiesInterface2.php">2</a></li>    
