  ...
  <body>
    ...
    .w-100 {
      height: 100vh;
        ...
        .header{
        background-image: linear-gradient(rgba(1,1,1,0.3),rgba(0,1,1,0.1)), url('../img/bg/fruit-bg.jpeg');
        ...
        <div class="container">
            ...
            <div class="fruits-gallery">
              <div class="pic plum">
                    <figure class="effect-ming tm-pic-item">
                        <img src ="../img/fruits/fruit-plum.jpeg" alt="Image" class="img-fluid"> 
                        <figcaption class="d-flex align-items-center justify-content-center">
                          <h2>Plum</h2>
                            <a href="plum-detail.html"></a>
                      </figcaption>                
                    </figure>
               </div>
               <div class="pic mangosteen">
                <figure class="effect-ming tm-pic-item">
                    <img src="../img/fruits/fruit-mangosteen.jpeg" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>Mangosteen</h2>
                        <a href="mangosteen-detail.html"></a>
                    </figcaption>                    
                </figure>
            </div>
                  <div class="pic melon">
                    <figure class="effect-ming tm-pic-item">
                        <img src="../img/fruits/fruit-melon.jpeg" alt="Image" class="img-fluid">
                        <figcaption class="d-flex align-items-center justify-content-center">
                            <h2>Melon</h2>
                            <a href="melon-detail.html"></a>
                        </figcaption>                    
                    </figure>
              </div>
                  <div class="pic raisins">
                    <figure class="effect-ming tm-pic-item">
                        <img src="../img/fruits/fruit-raisins.jpeg" alt="Image" class="img-fluid">
                        <figcaption class="d-flex align-items-center justify-content-center">
                            <h2>Raisins</h2>
                            <a href="raisins-detail.html"></a>
                        </figcaption>                    
                    </figure>
                  </div>
          ...
          *{
          ...
          i {
            ...
            <li class="page-item"><a class="page-link" href="../pages_php/fruitsInterface.php">1</a></li>
